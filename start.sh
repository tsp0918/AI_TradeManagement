...
for _MOD_ENTRY in "ai_classification:8002" "rnd_assessment:8003" "patent_search:8004" "screening:8005" "hs_classifier:8006" "export_license:8012" "trade_gate:8013" "fta_origin:8014"; do
  _MOD_KEY="${_MOD_ENTRY%%:*}"
